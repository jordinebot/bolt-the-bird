---
title: "7-0 en un draft fantasma!"
...
Com es plantegen els atacs en aquesta taula? Tots dos estàvem a 5 punts de vida. Jo tenia {{< cardname "Uncharted Voyage" >}} o {{< cardname "Bake into a pie">}} a la mà, i el meu oponent 3 cartes desconegudes i 4 terres obertes. Durant la partida vaig donar per fet que, si jo atacava amb tot, el rival intercanviaria el seu {{< cardname "Erudite Wizard" >}} pel meu {{< cardname "Bigfin Bouncer" >}} i donava per fet que tindria alguna mena d'interacció a la mà per a sobreviure. Vaig pensar que després del combat faria servir el meu {{< cardname "Bake into a pie">}} per desfer-me del seu 3/4 i sobreviure un torn més per atacar per guanyar...

El que no vaig considerar (error!) era que ell podia bloquejar un dels meus 2/2 sense perdre el seu defensor, deixant-lo en millor posició per contraatacar si tenia els recursos per sobreviure el meu atac. Afortunadament, per sobreviure, ell va haver de fer servir {{< cardname "Run Away Together|FDN" >}} que l'obligava a tornar una de les seves criatures a la mà i això em va salvar. Tot i que al torn posterior ell encara va posar un {{< cardname "Tolarian Terror" >}} en joc, vaig poder guanyar la partida gràcies a l'{{< cardname "Uncharted Voyage" >}}.
